                ...
                <div className='row'>
                    ...
                    <section className='col-12 filters sticky-top bg-white py-3'>
                        <div className='lead small'>
                            ...
                            <p className='my-1 provisionalInput'><label htmlFor="prov">Show provisional ratings</label>  <input type="checkbox" id="prov" defaultChecked={this.state.showProvisionalRatings} onChange={this.handleToggle} /></p>
                        </div>
                    </section>
                    <Tabela key={this.state.variantName} name={this.state.variantName} data={this.state.ratings[this.state.variantName]} minGames={this.state.minGames} single={true} prov={this.state.showProvisionalRatings} />
