                ...
                <div className='row'>
                    ...
                    <section className='col-12 filters sticky-top bg-white py-3'>
                        <div className='lead small'>
                            ...
                            <p className='my-1 provisionalInput'><label for="prov">Show provisional ratings</label>  <input type="checkbox" id="prov" defaultChecked={this.state.showProvisionalRatings} onChange={this.handleToggle} /></p>
                        </div>
                    </section>
